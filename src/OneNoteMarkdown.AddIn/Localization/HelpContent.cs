    ...
    internal static class HelpContent
    {
        ...
        private static string GetAboutZh()
        {
            return "<h1>关于 OneNote Markdown</h1>"
                + "<p class='version'>版本：1.2.1-fix</p>"
                + "<h2>开发背景</h2>"
        ...
        private static string GetQuickStartZh()
        {
            return "<h1>快速入门</h1>"
                ...
                + "<h2>第二步：安装插件</h2>"
                + "<ol>"
                + "<li>32 位 OneNote → 运行 <code>OneNoteMarkdownSetup-1.2.1-fix-x86.exe</code></li>"
                + "<li>x64 OneNote → 运行 <code>OneNoteMarkdownSetup-1.2.1-fix-x64.exe</code></li>"
                + "<li>Windows 11 原生 Arm64 OneNote → 运行 <code>OneNoteMarkdownSetup-1.2.1-fix-arm64.exe</code>（要求 .NET Framework 4.8.1）</li>"
        ...
        private static string GetAboutEn()
        {
            return "<h1>About OneNote Markdown</h1>"
                + "<p class='version'>Version: 1.2.1-fix</p>"
                + "<h2>Background</h2>"
        ...
        private static string GetQuickStartEn()
        {
            return "<h1>Quick Start</h1>"
                ...
                + "<ol>"
                + "<li>32-bit OneNote → Run <code>OneNoteMarkdownSetup-1.2.1-fix-x86.exe</code></li>"
                + "<li>x64 OneNote → Run <code>OneNoteMarkdownSetup-1.2.1-fix-x64.exe</code></li>"
                + "<li>Native Arm64 OneNote on Windows 11 → Run <code>OneNoteMarkdownSetup-1.2.1-fix-arm64.exe</code> (.NET Framework 4.8.1 required)</li>"
