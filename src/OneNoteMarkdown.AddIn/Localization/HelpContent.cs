    ...
    internal static class HelpContent
    {
        ...
        private static string GetAboutZh()
        {
            return "<h1>关于 OneNote Markdown</h1>"
                + "<p class='version'>版本：1.2.1-fix.4</p>"
                + "<h2>开发背景</h2>"
        ...
        private static string GetQuickStartZh()
        {
            return "<h1>快速入门</h1>"
                ...
                + "<h2>第二步：安装插件</h2>"
                + "<ol>"
                + "<li>32 位 OneNote → 运行 <code>OneNoteMarkdownSetup-1.2.1-fix.4-x86.exe</code></li>"
                + "<li>x64 OneNote → 运行 <code>OneNoteMarkdownSetup-1.2.1-fix.4-x64.exe</code></li>"
                + "<li>Windows 11 原生 Arm64 OneNote → 运行 <code>OneNoteMarkdownSetup-1.2.1-fix.4-arm64.exe</code>（要求 .NET Framework 4.8.1）</li>"
        ...
        private static string GetSettingsZh()
        {
            return "<h1>设置说明</h1>"
                ...
                + "<tr><td><code>preview.conflictNotification</code></td><td>true</td><td>预览正文被修改时询问是否覆盖；设为 false 时不提示并直接覆盖</td></tr>"
        ...
        private static string GetAboutEn()
        {
            return "<h1>About OneNote Markdown</h1>"
                + "<p class='version'>Version: 1.2.1-fix.4</p>"
                + "<h2>Background</h2>"
        ...
        private static string GetQuickStartEn()
        {
            return "<h1>Quick Start</h1>"
                ...
                + "<ol>"
                + "<li>32-bit OneNote → Run <code>OneNoteMarkdownSetup-1.2.1-fix.4-x86.exe</code></li>"
                + "<li>x64 OneNote → Run <code>OneNoteMarkdownSetup-1.2.1-fix.4-x64.exe</code></li>"
                + "<li>Native Arm64 OneNote on Windows 11 → Run <code>OneNoteMarkdownSetup-1.2.1-fix.4-arm64.exe</code> (.NET Framework 4.8.1 required)</li>"
        ...
        private static string GetSettingsEn()
        {
            return "<h1>Settings</h1>"
                ...
                + "<tr><td><code>preview.conflictNotification</code></td><td>true</td><td>Ask before overwriting an edited preview; false overwrites directly without prompting</td></tr>"
